...
export default function TodayPage() {
    ...
    const [assignmentBySlot, setAssignmentBySlot] = useState<Map<SlotId, SlotAssignment>>(
        new Map(),
    );
    ...
    const [attachmentsBySlot, setAttachmentsBySlot] = useState<Map<SlotId, LessonAttachment[]>>(
        new Map(),
    );
                ...
                <table style={{ width: '100%', borderCollapse: 'separate', borderSpacing: 8 }}>
                    ...
                    <tbody>
                        {cells.map(({ block, slotId, cell }) => {
                            ...
                            const detail =
                                cell.kind === 'template' ? detailForTemplateEvent(cell.e) : null;
