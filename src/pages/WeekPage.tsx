          ...
          >
            ...
            >
              {days.map((d, i) => {
                ...
                const dow = getDay(d);
                const capLeft = isSelectedWeek && dow === 1;
                const capRight = isSelectedWeek && (dow === 5 || dow === 0);
                const isWeekBand = isSelectedWeek && !isTodayDate;
                return (
                  <button
                    key={i}
                    type="button"
                    ...
                    style={{
                      ...
                      borderRadius: isTodayDate
                        ? "50%"
                        : isWeekBand
                          ? `${capLeft ? 16 : 0}px ${capRight ? 16 : 0}px ${capRight ? 16 : 0}px ${capLeft ? 16 : 0}px`
                          : "50%",
                      width: "100%",
                      height: 32,
                      display: "flex",
      ...
      <div className="card">
        ...
        >
          <div className="row" style={{ gap: 8, alignItems: "center" }}>
            ...
            >
              <svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ flex: "0 0 auto" }}>
