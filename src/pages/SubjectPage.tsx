...
export default function SubjectPage() {
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            function resolveFor(
                dayLabel: DayLabel,
                slotId: SlotId,
            ): { subjectId: string | null; room: string } {
            ...
            out.sort(
                (a, b) =>
                    a.dtSort - b.dtSort ||
                    SLOT_DEFS.findIndex((s) => s.id === a.slotId) -
                        SLOT_DEFS.findIndex((s) => s.id === b.slotId),
            );
    ...
    function headerForRow(r: { dateKey: string; slotId: SlotId }) {
        ...
        const tw = rollingSettings
            ? termWeekForDate(d, rollingSettings.termStarts, rollingSettings.termEnds)
            : null;
...
<body>
  ...
  ${rows
      .map((r) => {
          ...
          const sub = room;
          const body = !isHtmlEffectivelyEmpty(r.planHtml)
              ? r.planHtml!
    ...
    return (
        <div className='grid'>
            ...
            {isLoading ? (
                ...
                <div className='card'>
                    <div className='muted'>
                        No lessons found for the selected subject and period.
                    </div>
                </div>
            ) : (
                    ...
                    {rows.map((r) => {
                        ...
                        return (
                            <div
                                ...
                                className='card'
                                style={{ borderLeft: `4px solid ${r.subjectColor}` }}
                            >
                                <div>
